          ...
          <div className="text-center lg:text-left order-1">
            ...
            >
              <div className="glass-card p-3 rounded-2xl md:rounded-[2rem] flex flex-col gap-3 max-w-xl mx-auto lg:mx-0 shadow-lg border border-white/20">
                ...
                <Link href="/#download" className="text-center text-[10px] font-bold text-[#0B4619] uppercase tracking-widest hover:underline mt-1">
                  or Download the App for better experience
                </Link>
              </div>
            </motion.div>
