            ...
            <div className="hidden md:flex items-center space-x-4">
              {session?.user ? (
                ...
                <>
                  ...
                  <Link href="/#download" className="bg-[#0B132B] text-white px-6 py-2.5 rounded-full text-sm font-bold hover:bg-black transition-all duration-300 hover:-translate-y-0.5 active:scale-95 border border-white/10 hover-shadow-teal">
                    Download App
                  </Link>
                </>
              )}
              ...
              {!session?.user && (
                <>
                  <Link 
                    href="/#download" 
                    onClick={closeMobileMenu}
                    className="w-full flex items-center justify-center gap-2 bg-[#0B132B] text-white py-4 rounded-2xl text-base font-black shadow-xl active:scale-[0.97] transition-all hover-shadow-teal"
                  >
                    <Download size={18} />
                    Download App
                  </Link>
